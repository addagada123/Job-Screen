// Mock Data
const jobCategories = {
    plumbing: { name: 'Plumbing', keywords: ['pipe', 'water', 'drain', 'leak', 'bathroom', 'kitchen', 'fitting', 'valve', 'welding', 'installation', 'repair'] },
    masonry: { name: 'Masonry', keywords: ['brick', 'cement', 'concrete', 'tiles', 'stone', 'wall', 'floor', 'construction', 'mortar', 'plaster'] },
    driving: { name: 'Driving', keywords: ['license', 'vehicle', 'car', 'truck', 'delivery', 'transport', 'route', 'navigation', 'safety', 'traffic'] },
    electrical: { name: 'Electrical', keywords: ['wiring', 'circuit', 'panel', 'switch', 'outlet', 'voltage', 'power', 'lighting', 'installation', 'repair'] },
    carpentry: { name: 'Carpentry', keywords: ['wood', 'furniture', 'cabinet', 'door', 'window', 'frame', 'carpenter', 'joinery', 'cutting', 'sanding'] },
    painting: { name: 'Painting', keywords: ['paint', 'color', 'wall', 'interior', 'exterior', 'brush', 'roller', 'spray', 'texture', 'finish'] }
};
...
const skillKeywords = [
    'pipe fitting', 'drain cleaning', 'water heater', 'gas fitting', 'fixture installation', 'leak detection',
    'brick laying', 'concrete work', 'tile installation', 'stone work', 'plastering', 'pointing',
    'cdl', 'defensive driving', 'route planning', 'vehicle maintenance', 'load securement', 'dot compliance',
    'wiring', 'panel installation', 'circuit breaker', 'outlet installation', 'lighting', 'electrical repair',
    'furniture making', 'cabinet installation', 'door installation', 'window installation', 'framing', 'wood finishing',
    'interior painting', 'exterior painting', 'texture', 'faux finish', 'spray painting', 'color matching'
];

const sampleUsers = [
    { id: 'user1', name: 'Rajesh Kumar', email: 'rajesh@example.com', password: 'password123', role: 'user', resume: { fileName: 'rajesh_plumber.pdf', skills: ['pipe fitting', 'drain cleaning', 'water heater'], jobCategory: 'plumbing' }, tests: [{ id: 'test1', date: '2024-01-15', category: 'plumbing', score: 85, totalQuestions: 5 }] },
    { id: 'user2', name: 'Amit Sharma', email: 'amit@example.com', password: 'password123', role: 'user', resume: { fileName: 'amit_electrician.pdf', skills: ['wiring', 'panel installation', 'circuit breaker'], jobCategory: 'electrical' }, tests: [{ id: 'test2', date: '2024-01-14', category: 'electrical', score: 72, totalQuestions: 5 }] },
    { id: 'user3', name: 'Suresh Patel', email: 'suresh@example.com', password: 'password123', role: 'user', resume: { fileName: 'suresh_driver.pdf', skills: ['cdl', 'defensive driving', 'route planning'], jobCategory: 'driving' }, tests: [{ id: 'test3', date: '2024-01-13', category: 'driving', score: 90, totalQuestions: 5 }] },
    { id: 'user4', name: 'Mohammad Khan', email: 'khan@example.com', password: 'password123', role: 'user', resume: { fileName: 'khan_carpenter.pdf', skills: ['furniture making', 'cabinet installation'], jobCategory: 'carpentry' }, tests: [{ id: 'test4', date: '2024-01-12', category: 'carpentry', score: 65, totalQuestions: 5 }] },
    { id: 'user5', name: 'Vikram Singh', email: 'vikram@example.com', password: 'password123', role: 'user', resume: { fileName: 'vikram_mason.pdf', skills: ['brick laying', 'concrete work', 'tile installation'], jobCategory: 'masonry' }, tests: [{ id: 'test5', date: '2024-01-11', category: 'masonry', score: 78, totalQuestions: 5 }] }
];

window.mockData = { jobCategories, questionBank, skillKeywords, sampleUsers };
