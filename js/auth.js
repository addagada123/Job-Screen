...
function updateAuthUI() {
    ...
    if (user) {
        ...
        // Hide login/signup buttons everywhere else
        var loginBtns = document.querySelectorAll('.btn-login, .btn-signup');
        for (var i = 0; i < loginBtns.length; i++) loginBtns[i].style.display = 'none';
    } else {
        if (navAuth) navAuth.style.display = 'flex';
        if (navUser) navUser.style.display = 'none';
        var loginBtns = document.querySelectorAll('.btn-login, .btn-signup');
        for (var i = 0; i < loginBtns.length; i++) loginBtns[i].style.display = '';
    }
}
